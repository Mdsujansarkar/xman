<?php get_header(); ?>
    <main>
       <?php get_template_part('template-part/home/hero'); ?>
        <!-- About Section -->
        <div class="about-us mt-60 mb-60">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
        ...
        <!-- services Section -->
        <div class="services-section pt-60 pb-60">
            <div class="container">
                <div class="row">
                    <div class="col-xl-4">
                        <div class="about-main-contant">
    ...
    <!-- Video Section -->
    <div class="video-section pt-160 pb-160">
        <div class="container">
            <div class="row">
    ...
    <!-- Our Case Section -->
    <div class="our-case-section pt-100 pb-100">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="about-main-contant">
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="form-part">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <select class="form-control" id="exampleFormControlSelect1">
                          <option>Subject: I Would like do discase</option>
                          <option>2</option>
                          <option>3</option>
                          <option>4</option>
                          <option>5</option>
                      ...
                      <div class="form-group">
                        <textarea class="form-control" name="" id="" cols="20" rows="8"></textarea>
                      </div>
                      <button type="submit" class="action-btns">Submit</button> 
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="main-image">
                        <img src="images/here@1X.png" alt="">
                    </div>
                </div>
                <div class="col-xl-6">
